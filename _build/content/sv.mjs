...
./svitlo-node config <span class="kw">set</span> availability 24/7`,
  ...
  contact: {
    ...
    items: [
      ...
      { icon: '✈️', title: 'Telegram', body: 'Gå med i vår Telegram-grupp för snabba uppdateringar och community-chatt.', href: 'https://t.me/+8t6LS2j4CyJiOTU0' },
      { icon: '💬', title: 'Discord-community', body: 'Gå med i vår Discord för realtidsstöd och diskussioner med teamet och andra användare.', href: 'https://discord.gg/9wqA3fMfg' },
      { icon: '🐦', title: 'Följ oss på X', body: 'Håll dig uppdaterad med de senaste nyheterna och produktuppdateringarna.', href: 'https://x.com/Svitlochain' },
      { icon: '📘', title: 'Facebook', body: 'Följ vår Facebook-sida för nyheter och community-uppdateringar.', href: 'https://www.facebook.com/share/1D53mnv4kk/' },
