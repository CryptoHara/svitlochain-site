...
./svitlo-node config <span class="kw">set</span> availability 24/7`,
  ...
  contact: {
    ...
    items: [
      ...
      { icon: '✈️', title: 'Telegram', body: 'Join our Telegram group for quick updates and community chat.', href: 'https://t.me/+8t6LS2j4CyJiOTU0' },
      { icon: '💬', title: 'Discord community', body: 'Join our Discord for real-time support and discussion with the team and other users.', href: 'https://discord.gg/9wqA3fMfg' },
      { icon: '🐦', title: 'Follow us on X', body: 'Stay updated with the latest news and product updates.', href: 'https://x.com/Svitlochain' },
      { icon: '📘', title: 'Facebook', body: 'Follow our Facebook page for news and community updates.', href: 'https://www.facebook.com/share/1D53mnv4kk/' },
