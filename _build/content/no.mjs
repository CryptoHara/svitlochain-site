...
./svitlo-node config <span class="kw">set</span> availability 24/7`,
  ...
  contact: {
    ...
    items: [
      ...
      { icon: '💬', title: 'Discord-fellesskap', body: 'Bli med i vår Discord for sanntidsstøtte og diskusjoner med teamet og andre brukere.' },
      { icon: '🐦', title: 'Følg oss på X', body: 'Hold deg oppdatert med de siste nyhetene og produktoppdateringene.' },
